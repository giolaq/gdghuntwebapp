...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    }, "call$1", "get$noSuchMethod", 2, 0, null, 40],
    "%": "MediaError|MediaKeyError|Navigator|NavigatorCPU|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGAnimatedTransformList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["base_request", "package:http/src/base_request.dart", , Y, {
  ...
  BaseRequest_closure: {
    ...
    }, "call$2", null, 4, 0, null, 46, 47, "call"],
    $isFunction: true
  },
...
["dart.async", "dart:async", , P, {
  ...
  _BroadcastStreamController: {
    ...
    _async$_add$1: [function(data) {
      this._sendData$1(data);
    }, "call$1", "get$_async$_add", 2, 0, null, 51],
    _addError$2: [function(error, stackTrace) {
      this._sendError$2(error, stackTrace);
    }, "call$2", "get$_addError", 4, 0, null, 17, 18],
    _close$0: [function() {
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 52, 16, 17, 18]
  },
  _Future: {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:54;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
      var e, s, exception, t1;
      try {
  ...
  _BufferingStreamSubscription_asFuture_closure: {
    "^": "Closure:42;futureValue_0,result_1",
    call$0: function() {
  ...
  _DoneStreamSubscription_asFuture_closure: {
    "^": "Closure:42;result_0",
    call$0: function() {
      this.result_0._completeWithValue$1(null);
    },
    $isFunction: true
  },
  ...
  _cancelAndErrorClosure_closure: {
    "^": "Closure:58;subscription_0,future_1",
    call$2: function(error, stackTrace) {
  ...
  _ForwardingStreamSubscription: {
    ...
    _handleError$2: [function(error, stackTrace) {
      this._addError$2(error, stackTrace);
    }, "call$2", "get$_handleError", 4, 0, 59, 17, 18],
  ...
  _SinkTransformerStreamSubscription: {
    ...
    }, "_handleError$1", "call$2", "call$1", "get$_handleError", 2, 2, 60, 16, 17, 18],
    _handleDone$0: [function() {
      var e, s, exception, t1;
      try {
        this._subscription = null;
...
["dart.collection", "dart:collection", , P, {
  ...
  _LinkedHashMap_addAll_closure: {
    ...
    }, "call$2", null, 4, 0, null, 48, 14, "call"],
    $isFunction: true,
    $signature: function() {
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8ConversionSink: {
    ...
    close$0: function(_) {
      ...
      t1 = this._decoder;
      if (t1._expectedUnits > 0) {
        if (!t1._allowMalformed)
          H.throwExpression(P.FormatException$("Unfinished UTF-8 octet sequence", null, null));
        t1._stringSink.write$1(H.Primitives_stringFromCharCode(65533));
        t1._convert$_value = 0;
        t1._expectedUnits = 0;
        t1._extraUnits = 0;
      }
      t1 = this._buffer;
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:67;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["dart.core", "dart:core", , P, {
  ...
  Duration: {
    ...
    static: {"^": "Duration_MICROSECONDS_PER_MILLISECOND,Duration_MILLISECONDS_PER_SECOND,Duration_SECONDS_PER_MINUTE,Duration_MINUTES_PER_HOUR,Duration_HOURS_PER_DAY,Duration_MICROSECONDS_PER_SECOND,Duration_MICROSECONDS_PER_MINUTE,Duration_MICROSECONDS_PER_HOUR,Duration_MICROSECONDS_PER_DAY,Duration_MILLISECONDS_PER_MINUTE,Duration_MILLISECONDS_PER_HOUR,Duration_MILLISECONDS_PER_DAY,Duration_SECONDS_PER_HOUR,Duration_SECONDS_PER_DAY,Duration_MINUTES_PER_DAY,Duration_ZERO", Duration$: function(days, hours, microseconds, milliseconds, minutes, seconds) {
        var t1 = J.$mul$ns(seconds, 1000000);
        if (typeof t1 !== "number")
          return H.iae(t1);
  ...
  Uri: {
    ...
    static: {"^": "Uri__SPACE,Uri__DOUBLE_QUOTE,Uri__NUMBER_SIGN,Uri__PERCENT,Uri__ASTERISK,Uri__PLUS,Uri__DOT,Uri__SLASH,Uri__ZERO,Uri__NINE,Uri__COLON,Uri__LESS,Uri__GREATER,Uri__QUESTION,Uri__AT_SIGN,Uri__UPPER_CASE_A,Uri__UPPER_CASE_F,Uri__UPPER_CASE_Z,Uri__LEFT_BRACKET,Uri__BACKSLASH,Uri__RIGHT_BRACKET,Uri__LOWER_CASE_A,Uri__LOWER_CASE_F,Uri__LOWER_CASE_Z,Uri__BAR,Uri__unreservedTable,Uri__unreserved2396Table,Uri__encodeFullTable,Uri__schemeTable,Uri__schemeLowerTable,Uri__subDelimitersTable,Uri__genDelimitersTable,Uri__userinfoTable,Uri__regNameTable,Uri__pathCharTable,Uri__pathCharOrSlashTable,Uri__queryCharTable", Uri__defaultPort: function(scheme) {
      ...
      }, "call$1", "Uri_decodeComponent$closure", 2, 0, 25, 26], Uri_parseIPv4Address: function(host) {
        var t1, bytes;
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;type=",
    $isEvent: true,
    "%": "AnimationPlayerEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|FetchEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyNeededEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
  ...
  HttpRequest: {
    ...
    }, "call$2", "get$setRequestHeader", 4, 0, 38, 39, 14],
    $isHttpRequest: true,
    "%": "XMLHttpRequest"
  },
  HttpRequestEventTarget: {
...
["dart.js", "dart:js", , P, {
  ...
  JsObject__convertDataTree__convert: {
    "^": "Closure:31;_convertedObjects_0",
    call$1: [function(o) {
...
["dart.math", "dart:math", , P, {
  ...
  max: [function(a, b) {
    ...
    if (b === 0 && C.JSNumber_methods.get$isNegative(a))
      return b;
    return a;
  }, "call$2", "max$closure", 4, 0, 34, 21, 35]
}],
...
["frame", "package:stack_trace/src/frame.dart", , S, {
  ...
  Frame: {
    ...
    get$location: function(_) {
      ...
      t2 = this.column;
      if (t2 == null)
        return H.S($.get$context0().prettyUri$1(this.uri)) + " " + H.S(t1);
      return H.S($.get$context0().prettyUri$1(this.uri)) + " " + H.S(t1) + ":" + H.S(t2);
    },
    toString$0: function(_) {
...
["", "gdghunt.dart", , E, {
  "^": "",
  main: [function() {
    Z.createImplicitBrowserFlow(new B.ClientId("1095911519905-p6c1e3mm7pr550fsm4m957rr47bjo44r.apps.googleusercontent.com", "1BPU5F-emV3OGNbVyS3SS4oR"), ["https://www.googleapis.com/auth/plus.login", "https://www.googleapis.com/auth/games"], null).then$1(new E.main_closure());
  }, "call$0", "main$closure", 0, 0, 12],
  main_closure: {
    "^": "Closure:78;",
    call$1: [function(flow) {
      flow.clientViaUserConsent$0().then$1(new E.main__closure(flow));
  ...
  main__closure: {
    ...
    call$1: [function(client) {
      new D.LeaderboardsResourceApi(new V.ApiRequester(client, "https://www.googleapis.com/", "/games/v1/")).get$1(0, "CgkIoe2qy_IfEAIQAg").then$1(new E.main___closure());
      J.close$0$x(client);
      J.close$0$x(this.flow_0);
    }, "call$1", null, 2, 0, null, 79, "call"],
    $isFunction: true
  },
  main___closure: {
    "^": "Closure:82;",
    call$1: [function(leaderBoard) {
      P.print(J.get$id$x(leaderBoard));
    }, "call$1", null, 2, 0, null, 81, "call"],
    $isFunction: true
  }
},
1],
["googleapis.common", "package:googleapis/common/common.dart", , T, {
  "^": "",
  Media: {
    "^": "Object;stream>,contentType,length>",
    Media$3$contentType: function(stream, $length, contentType) {
      var t1;
      if (this.stream == null || this.contentType == null)
        throw H.wrapException(P.ArgumentError$("Arguments stream, contentType and length must not be null."));
      t1 = this.length;
      if (t1 != null && J.$lt$n(t1, 0))
        throw H.wrapException(P.ArgumentError$("A negative content length is not allowed"));
    }
  },
  UploadOptions: {
    "^": "Object;"
  ...
  DownloadOptions: {
    "^": "Object;",
    static: {"^": "DownloadOptions_Metadata,DownloadOptions_FullMedia"}
  },
  ApiRequestError: {
    "^": "Error;message>",
    toString$0: function(_) {
      return "ApiRequestError(message: " + H.S(this.message) + ")";
    },
    static: {ApiRequestError$: function(message) {
        return new T.ApiRequestError(message);
      }}
  },
  DetailedApiRequestError: {
    "^": "ApiRequestError;status,message",
    toString$0: function(_) {
      return "DetailedApiRequestError(status: " + H.S(this.status) + ", message: " + H.S(this.message) + ")";
    },
    static: {DetailedApiRequestError$: function($status, message) {
        return new T.DetailedApiRequestError($status, message);
      }}
  }
}],
["googleapis.common_internal", "package:googleapis/src/common_internal.dart", , V, {
  "^": "",
  _validateResponse: [function(response) {
    var statusCode, t1, stringStream, t2;
    statusCode = J.get$statusCode$x(response);
    if (typeof statusCode !== "number")
      return statusCode.$lt();
    if (statusCode < 200 || statusCode >= 400) {
      t1 = new V._validateResponse_throwGeneralError(response);
      stringStream = V._decodeStreamAsText(response);
      if (stringStream != null) {
        t2 = C.JsonCodec_null_null.get$decoder().bind$1(stringStream);
        return t2.get$first(t2).then$1(new V._validateResponse_closure(t1));
      } else
        t1.call$0();
    }
    return P._Future$immediate(response, null);
  }, "call$1", "_validateResponse$closure", 2, 0, 36, 37],
  _decodeStreamAsText: function(response) {
    var t1, contentType;
    t1 = J.getInterceptor$x(response);
    contentType = J.$index$asx(t1.get$headers(response), "content-type");
    if (contentType != null && C.JSString_methods.startsWith$1(J.toLowerCase$0$s(contentType), "application/json"))
      return J.transform$1$x(t1.get$stream(response), new P.Utf8Decoder(true));
    else
      return;
  },
  ApiRequester: {
    "^": "Object;_httpClient,_rootUrl,_basePath",
    request$7$body$downloadOptions$queryParams$uploadMedia$uploadOptions: function(_, requestUrl, method, body, downloadOptions, queryParams, uploadMedia, uploadOptions) {
      var t1 = {};
      t1.downloadRange_0 = null;
      return this._request$8(requestUrl, method, body, queryParams, uploadMedia, uploadOptions, downloadOptions, null).then$1(V._validateResponse$closure()).then$1(new V.ApiRequester_request_closure(t1, downloadOptions));
    },
    _request$8: function(requestUrl, method, body, queryParams, uploadMedia, uploadOptions, downloadOptions, downloadRange) {
      var t1, downloadAsMedia, t2, path, uri;
      t1 = {};
      downloadAsMedia = downloadOptions !== C.C_DownloadOptions;
      if (downloadAsMedia)
        queryParams.$indexSet(0, "alt", C.List_media);
      else
        queryParams.$indexSet(0, "alt", C.List_json);
      t1.path_0 = null;
      t2 = this._rootUrl;
      if (C.JSString_methods.startsWith$1(requestUrl, "/")) {
        path = t2 + C.JSString_methods.substring$1(requestUrl, 1);
        t1.path_0 = path;
        t2 = path;
      } else {
        path = t2 + C.JSString_methods.substring$1(this._basePath, 1) + requestUrl;
        t1.path_0 = path;
        t2 = path;
      }
      t1.containsQueryParameter_1 = C.JSString_methods.contains$1(t2, "?");
      queryParams.forEach$1(0, new V.ApiRequester__request_closure(new V.ApiRequester__request_addQueryParameter(t1)));
      uri = P.Uri_parse(t1.path_0);
      return new V.ApiRequester__request_simpleRequest(this, method, body, downloadRange, uri).call$0();
    }
  },
  ApiRequester_request_closure: {
    "^": "Closure:83;box_0,downloadOptions_1",
    call$1: [function(response) {
      var contentLength, t1, stringStream, contentType, exception, t2, t3;
      t1 = this.downloadOptions_1;
      if (t1 == null)
        return J.get$stream$x(response).drain$0();
      else if (t1 === C.C_DownloadOptions) {
        stringStream = V._decodeStreamAsText(response);
        if (stringStream != null)
          return stringStream.join$1(0, "").then$1(new V.ApiRequester_request__closure());
        else
          throw H.wrapException(T.ApiRequestError$("Unable to read response with content-type " + H.S(J.$index$asx(J.get$headers$x(response), "content-type")) + "."));
      } else {
        contentType = J.$index$asx(J.get$headers$x(response), "content-type");
        if (contentType == null)
          throw H.wrapException(T.ApiRequestError$("No 'content-type' header in media response."));
        contentLength = null;
        try {
          contentLength = H.Primitives_parseInt(J.$index$asx(J.get$headers$x(response), "content-length"), null, null);
        } catch (exception) {
          H.unwrapException(exception);
        }

        t1 = J.get$stream$x(response);
        t2 = contentLength;
        t3 = new T.Media(t1, contentType, t2);
        t3.Media$3$contentType(t1, t2, contentType);
        return t3;
      }
    }, "call$1", null, 2, 0, null, 37, "call"],
    $isFunction: true
  },
  ApiRequester_request__closure: {
    "^": "Closure:3;",
    call$1: [function(bodyString) {
      if (J.$eq(bodyString, ""))
        return;
      return C.JsonCodec_null_null.decode$1(bodyString);
    }, "call$1", null, 2, 0, null, 84, "call"],
    $isFunction: true
  },
  ApiRequester__request_addQueryParameter: {
    "^": "Closure:85;box_0",
    call$2: function($name, value) {
      var t1, t2, t3;
      $name = J.replaceAll$2$s(P.Uri__uriEncode(C.List_nxB, $name, C.Utf8Codec_false, true), "+", "%20");
      value = J.replaceAll$2$s(P.Uri__uriEncode(C.List_nxB, value, C.Utf8Codec_false, true), "+", "%20");
      t1 = this.box_0;
      t2 = t1.containsQueryParameter_1;
      t3 = t1.path_0;
      if (t2)
        t1.path_0 = H.S(t3) + "&" + H.S($name) + "=" + H.S(value);
      else
        t1.path_0 = H.S(t3) + "?" + H.S($name) + "=" + H.S(value);
      t1.containsQueryParameter_1 = true;
    },
    $isFunction: true
  },
  ApiRequester__request_closure: {
    "^": "Closure:87;addQueryParameter_1",
    call$2: [function(key, values) {
      var t1, t2;
      for (t1 = J.get$iterator$ax(values), t2 = this.addQueryParameter_1; t1.moveNext$0();)
        t2.call$2(key, t1.get$current());
    }, "call$2", null, 4, 0, null, 48, 86, "call"],
    $isFunction: true
  },
  ApiRequester__request_simpleUpload: {
    "^": "Closure:88;this_2,method_3,uploadMedia_4,uri_5",
    call$0: function() {
      var t1, request;
      t1 = this.uploadMedia_4;
      request = V.RequestImpl$(this.method_3, this.uri_5, C.JSNull_methods.get$stream(t1));
      request.headers.addAll$1(0, P.LinkedHashMap_LinkedHashMap$_literal(["user-agent", "google-api-dart-client googleapis/0.1.1", "content-type", C.JSNull_methods.get$contentType(t1), "content-length", H.S(C.JSNull_methods.get$length(t1))], null, null));
      return J.send$1$x(this.this_2._httpClient, request);
    },
    $isFunction: true
  },
  ApiRequester__request_simpleRequest: {
    "^": "Closure:88;this_6,method_7,body_8,downloadRange_9,uri_10",
    call$0: function() {
      var bodyController, headers, request;
      bodyController = P.StreamController_StreamController(null, null, null, null, false, [P.List, P.$int]);
      bodyController.close$0(0);
      headers = P.LinkedHashMap_LinkedHashMap$_literal(["user-agent", "google-api-dart-client googleapis/0.1.1", "content-type", "application/json; charset=utf-8", "content-length", "0"], null, null);
      request = V.RequestImpl$(this.method_7, this.uri_10, H.setRuntimeTypeInfo(new P._ControllerStream(bodyController), [null]));
      request.headers.addAll$1(0, headers);
      return J.send$1$x(this.this_6._httpClient, request);
    },
    $isFunction: true
  },
  RequestImpl: {
    "^": "BaseRequest;_common_internal$_stream,method,url,_contentLength,_persistentConnection,_followRedirects,_maxRedirects,headers,_finalized",
    finalize$0: function() {
      Y.BaseRequest.prototype.finalize$0.call(this);
      return new Z.ByteStream(this._common_internal$_stream);
    },
    static: {RequestImpl$: function(method, url, stream) {
        return new V.RequestImpl(stream, method, url, null, true, true, 5, P.LinkedHashMap_LinkedHashMap(new Y.BaseRequest_closure(), new Y.BaseRequest_closure0(), null, null, null), false);
      }}
  },
  _validateResponse_throwGeneralError: {
    "^": "Closure:42;response_0",
    call$0: function() {
      throw H.wrapException(T.ApiRequestError$("No error details. Http status was: " + H.S(J.get$statusCode$x(this.response_0)) + "."));
    },
    $isFunction: true
  },
  _validateResponse_closure: {
    "^": "Closure:31;throwGeneralError_1",
    call$1: [function(json) {
      var t1, error;
      t1 = J.getInterceptor(json);
      if (!!t1.$isMap && !!J.getInterceptor(t1.$index(json, "error")).$isMap) {
        error = t1.$index(json, "error");
        t1 = J.getInterceptor$asx(error);
        throw H.wrapException(T.DetailedApiRequestError$(t1.$index(error, "code"), t1.$index(error, "message")));
      } else
        this.throwGeneralError_1.call$0();
    }, "call$1", null, 2, 0, null, 89, "call"],
    $isFunction: true
  }
}],
["googleapis.games.v1", "package:googleapis/games/v1.dart", , D, {
  "^": "",
  GamesApi: {
    "^": "Object;_requester",
    static: {"^": "GamesApi_DriveAppdataScope,GamesApi_GamesScope,GamesApi_PlusLoginScope"}
  },
  LeaderboardsResourceApi: {
    "^": "Object;_requester",
    get$2$language: function(_, leaderboardId, language) {
      var _queryParams = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      return this._requester.request$7$body$downloadOptions$queryParams$uploadMedia$uploadOptions(0, C.JSString_methods.$add("leaderboards/", J.replaceAll$2$s(P.Uri__uriEncode(C.List_nxB, leaderboardId, C.Utf8Codec_false, true), "+", "%20")), "GET", null, C.C_DownloadOptions, _queryParams, null, null).then$1(new D.LeaderboardsResourceApi_get_closure());
    },
    get$1: function($receiver, leaderboardId) {
      return this.get$2$language($receiver, leaderboardId, null);
    }
  },
  LeaderboardsResourceApi_get_closure: {
    "^": "Closure:31;",
    call$1: [function(data) {
      var t1 = new D.Leaderboard(null, null, null, null, null, null);
      t1.Leaderboard$fromJson$1(data);
      return t1;
    }, "call$1", null, 2, 0, null, 51, "call"],
    $isFunction: true
  },
  Leaderboard: {
    "^": "Object;iconUrl,id>,isIconUrlDefault,kind,name,order",
    Leaderboard$fromJson$1: function(_json) {
      if (_json.containsKey$1("iconUrl"))
        this.iconUrl = J.$index$asx(_json, "iconUrl");
      if (_json.containsKey$1("id"))
        this.id = J.$index$asx(_json, "id");
      if (_json.containsKey$1("isIconUrlDefault"))
        this.isIconUrlDefault = J.$index$asx(_json, "isIconUrlDefault");
      if (_json.containsKey$1("kind"))
        this.kind = J.$index$asx(_json, "kind");
      if (_json.containsKey$1("name"))
        this.name = J.$index$asx(_json, "name");
      if (_json.containsKey$1("order"))
        this.order = J.$index$asx(_json, "order");
    }
  }
}],
["googleapis_auth", "package:googleapis_auth/src/auth_http_utils.dart", , O, {
  "^": "",
  AuthenticatedClient: {
    "^": "DelegatingClient;credentials,baseClient,closeUnderlyingClient,_isClosed",
    send$1: function(_, request) {
      var t1, t2, t3, t4, t5;
      t1 = J.getInterceptor$x(request);
      t2 = t1.get$method(request);
      t3 = t1.get$url(request);
      t4 = request.finalize$0();
      if (t4 == null)
        t4 = P.Stream_Stream$fromIterable([], null);
      t5 = P.LinkedHashMap_LinkedHashMap(new Y.BaseRequest_closure(), new Y.BaseRequest_closure0(), null, null, null);
      t5.addAll$1(0, t1.get$headers(request));
      t5.$indexSet(0, "Authorization", "Bearer " + H.S(J.get$data$x(this.credentials.get$accessToken())));
      return this.baseClient.send$1(0, new Z.RequestImpl0(t4, t2, t3, null, true, true, 5, t5, false)).then$1(new O.AuthenticatedClient_send_closure());
    }
  },
  AuthenticatedClient_send_closure: {
    "^": "Closure:31;",
    call$1: [function(response) {
      var t1, wwwAuthenticate;
      t1 = J.getInterceptor$x(response);
      wwwAuthenticate = J.$index$asx(t1.get$headers(response), "www-authenticate");
      if (wwwAuthenticate != null)
        return t1.get$stream(response).drain$0().then$1(new O.AuthenticatedClient_send__closure(wwwAuthenticate));
      return response;
    }, "call$1", null, 2, 0, null, 37, "call"],
    $isFunction: true
  },
  AuthenticatedClient_send__closure: {
    "^": "Closure:31;wwwAuthenticate_0",
    call$1: [function(_) {
      throw H.wrapException(B.AccessDeniedException$("Access was denied (www-authenticate header was: " + H.S(this.wwwAuthenticate_0) + ")."));
    }, "call$1", null, 2, 0, null, 49, "call"],
    $isFunction: true
  },
  AutoRefreshDelegatingClient: {
    "^": "DelegatingClient;",
    close$0: function(_) {
      this._credentialStreamController.close$0(0);
      Z.DelegatingClient.prototype.close$0.call(this, this);
    }
  }
}],
["googleapis_auth.auth", "package:googleapis_auth/auth.dart", , B, {
  ...
  authenticatedClient: function(baseClient, credentials) {
    if (!J.$eq(J.get$type$x(credentials.get$accessToken()), "Bearer"))
      throw H.wrapException(P.ArgumentError$("Only Bearer access tokens are accepted."));
    return new O.AuthenticatedClient(credentials, baseClient, false, false);
  },
  AccessToken: {
    "^": "Object;type>,data>,expiry",
    get$hasExpired: function() {
      var t1 = new P.DateTime(Date.now(), false);
      t1.DateTime$_now$0();
      return t1.toUtc$0().millisecondsSinceEpoch > this.expiry.millisecondsSinceEpoch;
    },
    toString$0: function(_) {
      return "AccessToken(type=" + this.type + ", data=" + H.S(this.data) + ", expiry=" + this.expiry.toString$0(0) + ")";
    },
    AccessToken$3: function(type, data, expiry) {
      var t1 = this.data == null || false;
      if (t1)
        throw H.wrapException(P.ArgumentError$("Arguments type/data/expiry may not be null."));
      if (!this.expiry.isUtc)
        throw H.wrapException(P.ArgumentError$("The expiry date must be a Utc DateTime."));
    }
  },
  AccessCredentials: {
  ...
  AccessDeniedException: {
    ...
    static: {AccessDeniedException$: function(message) {
        return new B.AccessDeniedException(message);
      }}
  },
...
["googleapis_auth.auth_browser", "package:googleapis_auth/auth_browser.dart", , Z, {
  ...
  createImplicitBrowserFlow: function(clientId, scopes, baseClient) {
    var t1, flow;
    t1 = {};
    t1.baseClient_0 = baseClient;
    t1.baseClient_0 = Z.RefCountedClient$(new Q.BrowserClient(P.LinkedHashSet_LinkedHashSet(null, null, null, W.HttpRequest)), 1);
    flow = new N.ImplicitFlow(clientId.identifier, scopes);
    return flow.initialize$0().catchError$1(new Z.createImplicitBrowserFlow_closure(t1)).then$1(new Z.createImplicitBrowserFlow_closure0(t1, scopes, flow));
  },
  createImplicitBrowserFlow_closure: {
    "^": "Closure:43;box_0",
    call$2: [function(error, stack) {
      var t1, t2;
      t1 = this.box_0.baseClient_0;
      t2 = t1._refCount;
      if (typeof t2 !== "number")
        return t2.$le();
      if (t2 <= 0)
        H.throwExpression(P.StateError$("This reference counted HTTP client has reached a count of zero and can no longer be used for making HTTP requests."));
      --t2;
      t1._refCount = t2;
      if (t2 === 0)
        Z.DelegatingClient.prototype.close$0.call(J.getInterceptor(t1), t1);
      return P._Future$immediateError(error, stack, null);
    }, "call$2", null, 4, 0, null, 17, 90, "call"],
    $isFunction: true
  },
  createImplicitBrowserFlow_closure0: {
    "^": "Closure:31;box_0,scopes_1,flow_2",
    call$1: [function(_) {
      return new Z.BrowserOAuth2Flow(this.flow_2, this.scopes_1, this.box_0.baseClient_0, false);
    }, "call$1", null, 2, 0, null, 49, "call"],
    $isFunction: true
  },
  BrowserOAuth2Flow: {
    "^": "Object;_flow,_auth_browser$_scopes,_client,_wasClosed",
    obtainAccessCredentialsViaUserConsent$1$forceUserConsent: function(forceUserConsent) {
      if (this._wasClosed)
        H.throwExpression(P.StateError$("BrowserOAuth2Flow has already been closed."));
      return this._flow.login$1$immediate(!forceUserConsent).then$1(new Z.BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure(this));
    },
    clientViaUserConsent$1$forceUserConsent: function(forceUserConsent) {
      if (this._wasClosed)
        H.throwExpression(P.StateError$("BrowserOAuth2Flow has already been closed."));
      return this.obtainAccessCredentialsViaUserConsent$1$forceUserConsent(forceUserConsent).then$1(new Z.BrowserOAuth2Flow_clientViaUserConsent_closure(this));
    },
    clientViaUserConsent$0: function() {
      return this.clientViaUserConsent$1$forceUserConsent(true);
    },
    close$0: function(_) {
      var t1, t2;
      if (this._wasClosed)
  ...
  BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure: {
    "^": "Closure:31;this_0",
    call$1: [function(accessToken) {
      if (accessToken == null || false)
        H.throwExpression(P.ArgumentError$("Arguments accessToken/scopes must not be null."));
      return new B.AccessCredentials(accessToken, null, this.this_0._auth_browser$_scopes);
    }, "call$1", null, 2, 0, null, 91, "call"],
    $isFunction: true
  },
  BrowserOAuth2Flow_clientViaUserConsent_closure: {
    "^": "Closure:31;this_0",
    call$1: [function(credentials) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = t1._client;
      t3 = t2._refCount;
      ...
      if (t3 <= 0)
        H.throwExpression(P.StateError$("This reference counted HTTP client has reached a count of zero and can no longer be used for making HTTP requests."));
      t2._refCount = t3 + 1;
      t3 = H.setRuntimeTypeInfo(new P._SyncBroadcastStreamController(null, null, 0, null, null, null, null), [null]);
      t3._async$_previous = t3;
      t3._async$_next = t3;
      t3 = new Z._AutoRefreshingBrowserClient(credentials, t1._flow, t1._auth_browser$_scopes, null, t3, t2, true, false);
      t3._authClient = B.authenticatedClient(t2, credentials);
      return t3;
    }, "call$1", null, 2, 0, null, 92, "call"],
    $isFunction: true
  },
  _AutoRefreshingBrowserClient: {
    "^": "AutoRefreshDelegatingClient;credentials,_flow,_auth_browser$_scopes,_authClient,_credentialStreamController,baseClient,closeUnderlyingClient,_isClosed",
    send$1: function(_, request) {
      if (!this.credentials.get$accessToken().get$hasExpired())
        return this._authClient.send$1(0, request);
      else
        return this._flow.login$1$immediate(true).then$1(new Z._AutoRefreshingBrowserClient_send_closure(this, request));
    }
  },
  _AutoRefreshingBrowserClient_send_closure: {
    "^": "Closure:31;this_0,request_1",
    call$1: [function(accessToken) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = new B.AccessCredentials(accessToken, null, t1._auth_browser$_scopes);
      if (accessToken == null || false)
        H.throwExpression(P.ArgumentError$("Arguments accessToken/scopes must not be null."));
      t1.credentials = t2;
      t3 = t1._credentialStreamController;
      if (t3._state >= 4)
        H.throwExpression(t3._addEventError$0());
      t3._sendData$1(t2);
      t2 = B.authenticatedClient(t1.baseClient, t1.credentials);
      t1._authClient = t2;
      return t2.send$1(0, this.request_1);
    }, "call$1", null, 2, 0, null, 91, "call"],
    $isFunction: true
  }
}],
["googleapis_auth.http_client_base", "package:googleapis_auth/src/http_client_base.dart", , Z, {
  ...
  DelegatingClient: {
    ...
    close$0: function(_) {
      ...
      this._isClosed = true;
      B.BaseClient.prototype.close$0.call(this, this);
  ...
  RefCountedClient: {
    ...
    static: {RefCountedClient$: function(baseClient, initialRefCount) {
  ...
  RequestImpl0: {
    "^": "BaseRequest;_http_client_base$_stream,method,url,_contentLength,_persistentConnection,_followRedirects,_maxRedirects,headers,_finalized",
    finalize$0: function() {
      Y.BaseRequest.prototype.finalize$0.call(this);
...
["googleapis_auth.implicit_gapi_flow", "package:googleapis_auth/src/oauth2_flows/implicit.dart", , N, {
  ...
  ImplicitFlow: {
    ...
    initialize$0: function() {
      ...
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      J.$indexSet$ax($.get$context(), "dartGapiLoaded", new N.ImplicitFlow_initialize_closure(completer));
      script = document.createElement("script", null);
      t1 = J.getInterceptor$x(script);
      t1.set$src(script, "https://apis.google.com/js/client.js?onload=dartGapiLoaded");
      t1 = t1.get$onError(script);
      t1.get$first(t1).then$1(new N.ImplicitFlow_initialize_closure0(completer));
      document.body.appendChild(script);
      return completer.future;
    },
    login$1$immediate: function(immediate) {
      var completer, gapi, t1;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      gapi = J.$index$asx(J.$index$asx($.get$context(), "gapi"), "auth");
      t1 = P.LinkedHashMap_LinkedHashMap$_literal(["client_id", this._clientId, "immediate", immediate, "response_type", "token", "scope", C.JSArray_methods.join$1(this._scopes, " ")], null, null);
      gapi.callMethod$2("authorize", [P._wrapToDart(P.JsObject__convertDataTree(t1)), new N.ImplicitFlow_login_closure(completer)]);
      return completer.future;
    }
  },
  ImplicitFlow_initialize_closure: {
    "^": "Closure:42;completer_0",
    call$0: [function() {
      J.$index$asx(J.$index$asx($.get$context(), "gapi"), "auth").callMethod$2("init", [new N.ImplicitFlow_initialize__closure(this.completer_0)]);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  ImplicitFlow_initialize__closure: {
    "^": "Closure:42;completer_1",
    call$0: [function() {
  ...
  ImplicitFlow_initialize_closure0: {
    ...
    call$1: [function(errorEvent) {
      this.completer_2.completeError$1(new P._ExceptionImplementation("Failed to load gapi library."));
    }, "call$1", null, 2, 0, null, 93, "call"],
    $isFunction: true
  },
  ImplicitFlow_login_closure: {
    "^": "Closure:31;completer_0",
    call$1: [function(jsTokenObject) {
      var t1, tokenType, token, expiresIn, error, t2, t3;
      ...
      expiresIn = t1.$index(jsTokenObject, "expires_in");
      t1.$index(jsTokenObject, "state");
      error = t1.$index(jsTokenObject, "error");
      if (typeof expiresIn === "string")
        expiresIn = H.Primitives_parseInt(expiresIn, null, null);
      if (error != null)
        this.completer_0.completeError$1(new B.UserConsentException("Failed to get user consent: " + H.S(error) + "."));
      else {
        t1 = token == null || typeof expiresIn !== "number" || Math.floor(expiresIn) !== expiresIn || !J.$eq(tokenType, "Bearer");
        t2 = this.completer_0;
        if (t1) {
          t1 = t2.future;
          if (t1._state !== 0)
            H.throwExpression(P.StateError$("Future already completed"));
          t1._asyncComplete$1(new P._ExceptionImplementation("Failed to obtain user consent. Invalid server response."));
        } else {
          t1 = new P.DateTime(Date.now(), false);
          t1.DateTime$_now$0();
          t1 = t1.toUtc$0().add$1(0, P.Duration$(0, 0, 0, 0, 0, J.$sub$n(expiresIn, 20)));
          t3 = new B.AccessToken("Bearer", token, t1);
          t3.AccessToken$3("Bearer", token, t1);
          t1 = t2.future;
          if (t1._state !== 0)
            H.throwExpression(P.StateError$("Future already completed"));
...
["http.browser_client", "package:http/browser_client.dart", , Q, {
  ...
  BrowserClient_send__closure: {
    "^": "Closure:31;request_2,xhr_3,completer_4",
    call$1: [function(_) {
  ...
  BrowserClient_send___closure: {
    "^": "Closure:31;request_5,xhr_6,completer_7,reader_8",
    call$1: [function(_) {
  ...
  BrowserClient_send___closure0: {
    "^": "Closure:31;request_9,completer_10",
    call$1: [function(error) {
  ...
  BrowserClient_send__closure0: {
    "^": "Closure:31;request_11,completer_12",
    call$1: [function(_) {
    ...
    relative$2$from: function(path, from) {
      ...
      if (!J.$eq(fromParsed.root, pathParsed.root)) {
        ...
        if (!(t2 == null || pathParsed.root == null)) {
          ...
          t2 = !J.$eq(t2, H.stringReplaceAllUnchecked(t3, "/", "\\"));
        } else
          t2 = true;
      } else
        t2 = false;
...
["path.style", "package:path/src/style.dart", , S, {
  ...
  Style__getPlatformStyle: function() {
    ...
    if (!J.endsWith$1$s(P.Uri_base()._path, "/"))
      return $.get$Style_url();
    if (J.$eq(P.Uri_Uri(null, null, "a/b", null, null, null, null, "", "").toFilePath$0(), "a\\b"))
...
["stack_trace.chain", "package:stack_trace/src/chain.dart", , O, {
  ...
  Chain: {
    ...
    $isChain: true,
    static: {"^": "Chain__GAP", Chain_Chain$current: function(level) {
        $.Zone__current.toString;
...
;(function() {
  ...
  _ = Z.BrowserOAuth2Flow;
  _.$isBrowserOAuth2Flow = TRUE;
  _.$isObject = TRUE;
  _ = B.AutoRefreshingAuthClient;
  _.$isAutoRefreshingAuthClient = TRUE;
  _.$isObject = TRUE;
  _ = D.Leaderboard;
  _.$isLeaderboard = TRUE;
  _.$isObject = TRUE;
...
C.C_DownloadOptions = new T.DownloadOptions();
...
C.List_json = Isolate.makeConstantList(["json"]);
C.List_media = Isolate.makeConstantList(["media"]);
...
"b",
{func: "Future__StreamedResponse", ret: [P.Future, Z.StreamedResponse], args: [Z.StreamedResponse]},
"response",
...
"flow",
{func: "dynamic__BrowserOAuth2Flow", args: [Z.BrowserOAuth2Flow]},
"client",
{func: "dynamic__AutoRefreshingAuthClient", args: [B.AutoRefreshingAuthClient]},
"leaderBoard",
{func: "dynamic__Leaderboard", args: [D.Leaderboard]},
{func: "dynamic__StreamedResponse", args: [Z.StreamedResponse]},
"bodyString",
...
//# sourceMappingURL=gdghunt.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function BaseRequest(method, url, headers) {
    this.method = method;
    this.url = url;
  ...
  BaseRequest.prototype.get$method = function(receiver) {
    return this.method;
  };
  BaseRequest.prototype.get$url = function(receiver) {
    return this.url;
  };
  ...
  function BaseResponse(statusCode, headers) {
  ...
  function _DoneStreamSubscription_asFuture_closure(result_0) {
    this.result_0 = result_0;
  }
  _DoneStreamSubscription_asFuture_closure.builtin$cls = "_DoneStreamSubscription_asFuture_closure";
  if (!"name" in _DoneStreamSubscription_asFuture_closure)
    _DoneStreamSubscription_asFuture_closure.name = "_DoneStreamSubscription_asFuture_closure";
  $desc = $collectedClasses._DoneStreamSubscription_asFuture_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _DoneStreamSubscription_asFuture_closure.prototype = $desc;
  ...
  function Media(stream, contentType, length) {
    this.stream = stream;
    this.contentType = contentType;
    this.length = length;
  }
  Media.builtin$cls = "Media";
  if (!"name" in Media)
    Media.name = "Media";
  $desc = $collectedClasses.Media;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Media.prototype = $desc;
  Media.prototype.get$stream = function(receiver) {
    return this.stream;
  };
  Media.prototype.get$length = function(receiver) {
    return this.length;
  };
  function UploadOptions() {
  }
  UploadOptions.builtin$cls = "UploadOptions";
  if (!"name" in UploadOptions)
    UploadOptions.name = "UploadOptions";
  $desc = $collectedClasses.UploadOptions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UploadOptions.prototype = $desc;
  function DownloadOptions() {
  }
  DownloadOptions.builtin$cls = "DownloadOptions";
  if (!"name" in DownloadOptions)
    DownloadOptions.name = "DownloadOptions";
  $desc = $collectedClasses.DownloadOptions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DownloadOptions.prototype = $desc;
  function ApiRequestError(message) {
    this.message = message;
  }
  ApiRequestError.builtin$cls = "ApiRequestError";
  if (!"name" in ApiRequestError)
    ApiRequestError.name = "ApiRequestError";
  $desc = $collectedClasses.ApiRequestError;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequestError.prototype = $desc;
  ApiRequestError.prototype.get$message = function(receiver) {
    return this.message;
  };
  function DetailedApiRequestError(status, message) {
    this.status = status;
    this.message = message;
  }
  DetailedApiRequestError.builtin$cls = "DetailedApiRequestError";
  if (!"name" in DetailedApiRequestError)
    DetailedApiRequestError.name = "DetailedApiRequestError";
  $desc = $collectedClasses.DetailedApiRequestError;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DetailedApiRequestError.prototype = $desc;
  function ApiRequester(_httpClient, _rootUrl, _basePath) {
    this._httpClient = _httpClient;
    this._rootUrl = _rootUrl;
    this._basePath = _basePath;
  }
  ApiRequester.builtin$cls = "ApiRequester";
  if (!"name" in ApiRequester)
    ApiRequester.name = "ApiRequester";
  $desc = $collectedClasses.ApiRequester;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester.prototype = $desc;
  function ApiRequester_request_closure(box_0, downloadOptions_1) {
    this.box_0 = box_0;
    this.downloadOptions_1 = downloadOptions_1;
  }
  ApiRequester_request_closure.builtin$cls = "ApiRequester_request_closure";
  if (!"name" in ApiRequester_request_closure)
    ApiRequester_request_closure.name = "ApiRequester_request_closure";
  $desc = $collectedClasses.ApiRequester_request_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester_request_closure.prototype = $desc;
  function ApiRequester_request__closure() {
  }
  ApiRequester_request__closure.builtin$cls = "ApiRequester_request__closure";
  if (!"name" in ApiRequester_request__closure)
    ApiRequester_request__closure.name = "ApiRequester_request__closure";
  $desc = $collectedClasses.ApiRequester_request__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester_request__closure.prototype = $desc;
  function ApiRequester__request_addQueryParameter(box_0) {
    this.box_0 = box_0;
  }
  ApiRequester__request_addQueryParameter.builtin$cls = "ApiRequester__request_addQueryParameter";
  if (!"name" in ApiRequester__request_addQueryParameter)
    ApiRequester__request_addQueryParameter.name = "ApiRequester__request_addQueryParameter";
  $desc = $collectedClasses.ApiRequester__request_addQueryParameter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester__request_addQueryParameter.prototype = $desc;
  function ApiRequester__request_closure(addQueryParameter_1) {
    this.addQueryParameter_1 = addQueryParameter_1;
  }
  ApiRequester__request_closure.builtin$cls = "ApiRequester__request_closure";
  if (!"name" in ApiRequester__request_closure)
    ApiRequester__request_closure.name = "ApiRequester__request_closure";
  $desc = $collectedClasses.ApiRequester__request_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester__request_closure.prototype = $desc;
  function ApiRequester__request_simpleUpload(this_2, method_3, uploadMedia_4, uri_5) {
    this.this_2 = this_2;
    this.method_3 = method_3;
    this.uploadMedia_4 = uploadMedia_4;
    this.uri_5 = uri_5;
  }
  ApiRequester__request_simpleUpload.builtin$cls = "ApiRequester__request_simpleUpload";
  if (!"name" in ApiRequester__request_simpleUpload)
    ApiRequester__request_simpleUpload.name = "ApiRequester__request_simpleUpload";
  $desc = $collectedClasses.ApiRequester__request_simpleUpload;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester__request_simpleUpload.prototype = $desc;
  function ApiRequester__request_simpleRequest(this_6, method_7, body_8, downloadRange_9, uri_10) {
    this.this_6 = this_6;
    this.method_7 = method_7;
    this.body_8 = body_8;
    this.downloadRange_9 = downloadRange_9;
    this.uri_10 = uri_10;
  }
  ApiRequester__request_simpleRequest.builtin$cls = "ApiRequester__request_simpleRequest";
  if (!"name" in ApiRequester__request_simpleRequest)
    ApiRequester__request_simpleRequest.name = "ApiRequester__request_simpleRequest";
  $desc = $collectedClasses.ApiRequester__request_simpleRequest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ApiRequester__request_simpleRequest.prototype = $desc;
  function RequestImpl(_common_internal$_stream, method, url, _contentLength, _persistentConnection, _followRedirects, _maxRedirects, headers, _finalized) {
    this._common_internal$_stream = _common_internal$_stream;
    this.method = method;
    this.url = url;
  ...
  RequestImpl.builtin$cls = "RequestImpl";
  if (!"name" in RequestImpl)
    RequestImpl.name = "RequestImpl";
  $desc = $collectedClasses.RequestImpl;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RequestImpl.prototype = $desc;
  function _validateResponse_throwGeneralError(response_0) {
    this.response_0 = response_0;
  }
  _validateResponse_throwGeneralError.builtin$cls = "_validateResponse_throwGeneralError";
  if (!"name" in _validateResponse_throwGeneralError)
    _validateResponse_throwGeneralError.name = "_validateResponse_throwGeneralError";
  $desc = $collectedClasses._validateResponse_throwGeneralError;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _validateResponse_throwGeneralError.prototype = $desc;
  function _validateResponse_closure(throwGeneralError_1) {
    this.throwGeneralError_1 = throwGeneralError_1;
  }
  _validateResponse_closure.builtin$cls = "_validateResponse_closure";
  if (!"name" in _validateResponse_closure)
    _validateResponse_closure.name = "_validateResponse_closure";
  $desc = $collectedClasses._validateResponse_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _validateResponse_closure.prototype = $desc;
  function GamesApi(_requester) {
    this._requester = _requester;
  }
  GamesApi.builtin$cls = "GamesApi";
  if (!"name" in GamesApi)
    GamesApi.name = "GamesApi";
  $desc = $collectedClasses.GamesApi;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GamesApi.prototype = $desc;
  function LeaderboardsResourceApi(_requester) {
    this._requester = _requester;
  }
  LeaderboardsResourceApi.builtin$cls = "LeaderboardsResourceApi";
  if (!"name" in LeaderboardsResourceApi)
    LeaderboardsResourceApi.name = "LeaderboardsResourceApi";
  $desc = $collectedClasses.LeaderboardsResourceApi;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LeaderboardsResourceApi.prototype = $desc;
  function LeaderboardsResourceApi_get_closure() {
  }
  LeaderboardsResourceApi_get_closure.builtin$cls = "LeaderboardsResourceApi_get_closure";
  if (!"name" in LeaderboardsResourceApi_get_closure)
    LeaderboardsResourceApi_get_closure.name = "LeaderboardsResourceApi_get_closure";
  $desc = $collectedClasses.LeaderboardsResourceApi_get_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LeaderboardsResourceApi_get_closure.prototype = $desc;
  function Leaderboard(iconUrl, id, isIconUrlDefault, kind, name, order) {
  ...
  Leaderboard.builtin$cls = "Leaderboard";
  if (!"name" in Leaderboard)
    Leaderboard.name = "Leaderboard";
  $desc = $collectedClasses.Leaderboard;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Leaderboard.prototype = $desc;
  Leaderboard.prototype.get$id = function(receiver) {
    return this.id;
  };
  function AuthenticatedClient(credentials, baseClient, closeUnderlyingClient, _isClosed) {
    this.credentials = credentials;
    this.baseClient = baseClient;
    this.closeUnderlyingClient = closeUnderlyingClient;
    this._isClosed = _isClosed;
  }
  AuthenticatedClient.builtin$cls = "AuthenticatedClient";
  if (!"name" in AuthenticatedClient)
    AuthenticatedClient.name = "AuthenticatedClient";
  $desc = $collectedClasses.AuthenticatedClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AuthenticatedClient.prototype = $desc;
  function AuthenticatedClient_send_closure() {
  }
  AuthenticatedClient_send_closure.builtin$cls = "AuthenticatedClient_send_closure";
  if (!"name" in AuthenticatedClient_send_closure)
    AuthenticatedClient_send_closure.name = "AuthenticatedClient_send_closure";
  $desc = $collectedClasses.AuthenticatedClient_send_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AuthenticatedClient_send_closure.prototype = $desc;
  function AuthenticatedClient_send__closure(wwwAuthenticate_0) {
    this.wwwAuthenticate_0 = wwwAuthenticate_0;
  }
  AuthenticatedClient_send__closure.builtin$cls = "AuthenticatedClient_send__closure";
  if (!"name" in AuthenticatedClient_send__closure)
    AuthenticatedClient_send__closure.name = "AuthenticatedClient_send__closure";
  $desc = $collectedClasses.AuthenticatedClient_send__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AuthenticatedClient_send__closure.prototype = $desc;
  function AutoRefreshDelegatingClient() {
  }
  AutoRefreshDelegatingClient.builtin$cls = "AutoRefreshDelegatingClient";
  if (!"name" in AutoRefreshDelegatingClient)
    AutoRefreshDelegatingClient.name = "AutoRefreshDelegatingClient";
  $desc = $collectedClasses.AutoRefreshDelegatingClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AutoRefreshDelegatingClient.prototype = $desc;
  function AccessToken(type, data, expiry) {
    this.type = type;
    this.data = data;
    this.expiry = expiry;
  }
  AccessToken.builtin$cls = "AccessToken";
  if (!"name" in AccessToken)
    AccessToken.name = "AccessToken";
  $desc = $collectedClasses.AccessToken;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AccessToken.prototype = $desc;
  AccessToken.prototype.get$type = function(receiver) {
    return this.type;
  };
  AccessToken.prototype.get$data = function(receiver) {
    return this.data;
  };
  function AccessCredentials(accessToken, refreshToken, scopes) {
    this.accessToken = accessToken;
    this.refreshToken = refreshToken;
    this.scopes = scopes;
  }
  AccessCredentials.builtin$cls = "AccessCredentials";
  if (!"name" in AccessCredentials)
    AccessCredentials.name = "AccessCredentials";
  $desc = $collectedClasses.AccessCredentials;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AccessCredentials.prototype = $desc;
  AccessCredentials.prototype.get$accessToken = function() {
    return this.accessToken;
  };
  function ClientId(identifier, secret) {
    this.identifier = identifier;
    this.secret = secret;
  }
  ClientId.builtin$cls = "ClientId";
  if (!"name" in ClientId)
    ClientId.name = "ClientId";
  $desc = $collectedClasses.ClientId;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ClientId.prototype = $desc;
  function AutoRefreshingAuthClient() {
  }
  AutoRefreshingAuthClient.builtin$cls = "AutoRefreshingAuthClient";
  if (!"name" in AutoRefreshingAuthClient)
    AutoRefreshingAuthClient.name = "AutoRefreshingAuthClient";
  $desc = $collectedClasses.AutoRefreshingAuthClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AutoRefreshingAuthClient.prototype = $desc;
  function AccessDeniedException(message) {
    this.message = message;
  }
  AccessDeniedException.builtin$cls = "AccessDeniedException";
  if (!"name" in AccessDeniedException)
    AccessDeniedException.name = "AccessDeniedException";
  $desc = $collectedClasses.AccessDeniedException;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AccessDeniedException.prototype = $desc;
  AccessDeniedException.prototype.get$message = function(receiver) {
    return this.message;
  };
  function UserConsentException(message) {
    this.message = message;
  }
  UserConsentException.builtin$cls = "UserConsentException";
  if (!"name" in UserConsentException)
    UserConsentException.name = "UserConsentException";
  $desc = $collectedClasses.UserConsentException;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UserConsentException.prototype = $desc;
  UserConsentException.prototype.get$message = function(receiver) {
    return this.message;
  };
  function createImplicitBrowserFlow_closure(box_0) {
    this.box_0 = box_0;
  }
  createImplicitBrowserFlow_closure.builtin$cls = "createImplicitBrowserFlow_closure";
  if (!"name" in createImplicitBrowserFlow_closure)
    createImplicitBrowserFlow_closure.name = "createImplicitBrowserFlow_closure";
  $desc = $collectedClasses.createImplicitBrowserFlow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createImplicitBrowserFlow_closure.prototype = $desc;
  function createImplicitBrowserFlow_closure0(box_0, scopes_1, flow_2) {
    this.box_0 = box_0;
    this.scopes_1 = scopes_1;
    this.flow_2 = flow_2;
  }
  createImplicitBrowserFlow_closure0.builtin$cls = "createImplicitBrowserFlow_closure0";
  if (!"name" in createImplicitBrowserFlow_closure0)
    createImplicitBrowserFlow_closure0.name = "createImplicitBrowserFlow_closure0";
  $desc = $collectedClasses.createImplicitBrowserFlow_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createImplicitBrowserFlow_closure0.prototype = $desc;
  function BrowserOAuth2Flow(_flow, _auth_browser$_scopes, _client, _wasClosed) {
    this._flow = _flow;
    this._auth_browser$_scopes = _auth_browser$_scopes;
    this._client = _client;
    this._wasClosed = _wasClosed;
  }
  BrowserOAuth2Flow.builtin$cls = "BrowserOAuth2Flow";
  if (!"name" in BrowserOAuth2Flow)
    BrowserOAuth2Flow.name = "BrowserOAuth2Flow";
  $desc = $collectedClasses.BrowserOAuth2Flow;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BrowserOAuth2Flow.prototype = $desc;
  function BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure(this_0) {
    this.this_0 = this_0;
  }
  BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure.builtin$cls = "BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure";
  if (!"name" in BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure)
    BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure.name = "BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure";
  $desc = $collectedClasses.BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BrowserOAuth2Flow_obtainAccessCredentialsViaUserConsent_closure.prototype = $desc;
  function BrowserOAuth2Flow_clientViaUserConsent_closure(this_0) {
    this.this_0 = this_0;
  }
  BrowserOAuth2Flow_clientViaUserConsent_closure.builtin$cls = "BrowserOAuth2Flow_clientViaUserConsent_closure";
  if (!"name" in BrowserOAuth2Flow_clientViaUserConsent_closure)
    BrowserOAuth2Flow_clientViaUserConsent_closure.name = "BrowserOAuth2Flow_clientViaUserConsent_closure";
  $desc = $collectedClasses.BrowserOAuth2Flow_clientViaUserConsent_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BrowserOAuth2Flow_clientViaUserConsent_closure.prototype = $desc;
  function _AutoRefreshingBrowserClient(credentials, _flow, _auth_browser$_scopes, _authClient, _credentialStreamController, baseClient, closeUnderlyingClient, _isClosed) {
    this.credentials = credentials;
    this._flow = _flow;
    this._auth_browser$_scopes = _auth_browser$_scopes;
    this._authClient = _authClient;
    this._credentialStreamController = _credentialStreamController;
    this.baseClient = baseClient;
    this.closeUnderlyingClient = closeUnderlyingClient;
    this._isClosed = _isClosed;
  }
  _AutoRefreshingBrowserClient.builtin$cls = "_AutoRefreshingBrowserClient";
  if (!"name" in _AutoRefreshingBrowserClient)
    _AutoRefreshingBrowserClient.name = "_AutoRefreshingBrowserClient";
  $desc = $collectedClasses._AutoRefreshingBrowserClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _AutoRefreshingBrowserClient.prototype = $desc;
  function _AutoRefreshingBrowserClient_send_closure(this_0, request_1) {
    this.this_0 = this_0;
    this.request_1 = request_1;
  }
  _AutoRefreshingBrowserClient_send_closure.builtin$cls = "_AutoRefreshingBrowserClient_send_closure";
  if (!"name" in _AutoRefreshingBrowserClient_send_closure)
    _AutoRefreshingBrowserClient_send_closure.name = "_AutoRefreshingBrowserClient_send_closure";
  $desc = $collectedClasses._AutoRefreshingBrowserClient_send_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _AutoRefreshingBrowserClient_send_closure.prototype = $desc;
  function DelegatingClient() {
  }
  DelegatingClient.builtin$cls = "DelegatingClient";
  if (!"name" in DelegatingClient)
    DelegatingClient.name = "DelegatingClient";
  $desc = $collectedClasses.DelegatingClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DelegatingClient.prototype = $desc;
  function RefCountedClient(_refCount, baseClient, closeUnderlyingClient, _isClosed) {
    this._refCount = _refCount;
    this.baseClient = baseClient;
    this.closeUnderlyingClient = closeUnderlyingClient;
    this._isClosed = _isClosed;
  }
  RefCountedClient.builtin$cls = "RefCountedClient";
  if (!"name" in RefCountedClient)
    RefCountedClient.name = "RefCountedClient";
  $desc = $collectedClasses.RefCountedClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RefCountedClient.prototype = $desc;
  function RequestImpl0(_http_client_base$_stream, method, url, _contentLength, _persistentConnection, _followRedirects, _maxRedirects, headers, _finalized) {
    this._http_client_base$_stream = _http_client_base$_stream;
    this.method = method;
    this.url = url;
    this._contentLength = _contentLength;
    this._persistentConnection = _persistentConnection;
  ...
  RequestImpl0.builtin$cls = "RequestImpl0";
  if (!"name" in RequestImpl0)
    RequestImpl0.name = "RequestImpl0";
  $desc = $collectedClasses.RequestImpl0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RequestImpl0.prototype = $desc;
  function ImplicitFlow(_clientId, _scopes) {
    this._clientId = _clientId;
    this._scopes = _scopes;
  }
  ImplicitFlow.builtin$cls = "ImplicitFlow";
  if (!"name" in ImplicitFlow)
    ImplicitFlow.name = "ImplicitFlow";
  $desc = $collectedClasses.ImplicitFlow;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImplicitFlow.prototype = $desc;
  function ImplicitFlow_initialize_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  ImplicitFlow_initialize_closure.builtin$cls = "ImplicitFlow_initialize_closure";
  if (!"name" in ImplicitFlow_initialize_closure)
    ImplicitFlow_initialize_closure.name = "ImplicitFlow_initialize_closure";
  $desc = $collectedClasses.ImplicitFlow_initialize_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImplicitFlow_initialize_closure.prototype = $desc;
  function ImplicitFlow_initialize__closure(completer_1) {
    this.completer_1 = completer_1;
  }
  ImplicitFlow_initialize__closure.builtin$cls = "ImplicitFlow_initialize__closure";
  if (!"name" in ImplicitFlow_initialize__closure)
    ImplicitFlow_initialize__closure.name = "ImplicitFlow_initialize__closure";
  $desc = $collectedClasses.ImplicitFlow_initialize__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImplicitFlow_initialize__closure.prototype = $desc;
  function ImplicitFlow_initialize_closure0(completer_2) {
    this.completer_2 = completer_2;
  }
  ImplicitFlow_initialize_closure0.builtin$cls = "ImplicitFlow_initialize_closure0";
  if (!"name" in ImplicitFlow_initialize_closure0)
    ImplicitFlow_initialize_closure0.name = "ImplicitFlow_initialize_closure0";
  $desc = $collectedClasses.ImplicitFlow_initialize_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImplicitFlow_initialize_closure0.prototype = $desc;
  function ImplicitFlow_login_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  ImplicitFlow_login_closure.builtin$cls = "ImplicitFlow_login_closure";
  if (!"name" in ImplicitFlow_login_closure)
    ImplicitFlow_login_closure.name = "ImplicitFlow_login_closure";
  $desc = $collectedClasses.ImplicitFlow_login_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImplicitFlow_login_closure.prototype = $desc;
